...
const jsonSchema = BncrCreateSchema.object({
  ...
  module.exports = async () => {
    ...
    const opt = {
      ...
      //     agentClass: Agent,
      //     agentOptions: {
      //         socksHost: ConfigDB.userConfig.proxy.host,
      //         socksPort: ConfigDB.userConfig.proxy.port,
      //         socksUsername: ConfigDB.userConfig.proxy.username,
      //         socksPassword: ConfigDB.userConfig.proxy.password,
      //     },
    ...
    tgBot.on('polling_error', msg => console.log('tgBot轮询错误:', msg));
